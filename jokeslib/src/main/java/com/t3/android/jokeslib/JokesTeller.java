package com.t3.android.jokeslib;
//Jokes source -> "https://www.techrepublic.com/article/the-geekiest-tech-jokes-on-the-internet/"

import java.util.Random;

public class JokesTeller {
    static private String[] jokes = new String[]{"There are 10 types of people in the world: those who understand binary, and those who don't." +
    ...
    public String getRandom() {
        int randomNumber = new Random().nextInt(jokes.length);
